...
STRICT REQUIREMENTS:
- Return a single JSON object with exactly these top-level keys: "version", "topic", "summary", "nodes", "edges" (optional "meta").
- Every node must include: "id", "type": "mindmapNode", and "data" object.
- Every edge must include: "id", "source", "target", "type": "mindmapEdge".
- Do not wrap the result in "data", "mindmap", "output", or any other envelope key.
