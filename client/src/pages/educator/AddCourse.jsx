        ...
        <div className="flex items-center justify-between flex-wrap">
          ...
          <div className="flex flex-col gap-1">
            ...
            <label htmlFor="thumbnailImage" className="flex items-center gap-3">
              ...
              {typeof image === 'string' ? <img src={image} alt="" className='w-24 h-16 object-cover' /> : image && <img src={URL.createObjectURL(image)} alt="" className='w-24 h-16 object-cover' />}
            </label>
          </div>
        </div>
        ...
        <div>
                ...
                <div className="p-4">
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className="flex justify-between items-center mb-2">
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration} mins - <a href={lecture.lectureUrl} target="_blank" className="text-blue-500">Link</a> - {lecture.isPreviewFree ? 'Free' : 'Paid'}</span>
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="bg-white text-gray-700 p-4 rounded-lg w-full max-w-80">
                ...
                <div className="mb-2">
                  ...
                  <input
                    type="text"
                    className="mt-1 block w-full border rounded-md py-1 px-2"
